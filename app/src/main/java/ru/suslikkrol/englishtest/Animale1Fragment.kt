...
import ru.suslikkrol.englishtest.databinding.FragmentAnimale1Binding

class Animale1Fragment : Fragment() {
    private lateinit var binding: FragmentAnimale1Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentAnimale1Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.layoutAnswer3.setOnClickListener {
            ...
            binding.layoutAnswer1.isClickable = false
            binding.layoutAnswer2.isClickable = false
            binding.layoutAnswer3.isClickable = false
            binding.layoutAnswer4.isClickable = false
        }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Animale1Fragment()
    }
}