...
import ru.suslikkrol.englishtest.databinding.FragmentAnimale3Binding


class Animale3Fragment : Fragment() {
    private lateinit var binding: FragmentAnimale3Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentAnimale3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Animale3Fragment()
    }
}