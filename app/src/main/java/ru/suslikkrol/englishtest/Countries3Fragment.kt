...
import ru.suslikkrol.englishtest.databinding.FragmentCountries3Binding

class Countries3Fragment : Fragment() {
    private lateinit var binding: FragmentCountries3Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentCountries3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Countries3Fragment()
    }
}