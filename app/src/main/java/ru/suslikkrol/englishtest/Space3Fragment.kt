...
import ru.suslikkrol.englishtest.databinding.FragmentSpace3Binding

class Space3Fragment : Fragment() {
    private lateinit var binding: FragmentSpace3Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentSpace3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Space3Fragment()
                }
            }
