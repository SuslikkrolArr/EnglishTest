...
import ru.suslikkrol.englishtest.databinding.FragmentCountries2Binding

class Countries2Fragment : Fragment() {
    private lateinit var binding: FragmentCountries2Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentCountries2Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Countries2Fragment()
    }
}