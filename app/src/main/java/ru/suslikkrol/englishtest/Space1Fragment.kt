...
import ru.suslikkrol.englishtest.databinding.FragmentSpace1Binding


class Space1Fragment : Fragment() {
    private lateinit var binding: FragmentSpace1Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentSpace1Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Space1Fragment()
                }
            }