...
import ru.suslikkrol.englishtest.databinding.FragmentCountries1Binding

class Countries1Fragment : Fragment() {
    private lateinit var binding: FragmentCountries1Binding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentCountries1Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Countries1Fragment()
    }
}